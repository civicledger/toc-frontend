                          ...
                          <Form>
                            <div className="mt-3">
                              ...
                              <div className="mb-5">
                                ...
                                {!props.errors.name && <p className="text-gray-600 text-sm mt-1 mx-2">Provide a name to describe this output</p>}
                              ...
                              <div className="mb-5">
                                ...
                                {!props.errors.description && (
                                  <p className="text-gray-600 text-sm mt-1 mx-2">Describe this output for anyone reading</p>
                                )}
                            ...
                            <div className="mt-5 sm:mt-4 sm:flex sm:flex-row-reverse">
                              ...
                              >
                                <PlusCircleIcon className="w-5 inline-block mr-2" /> Create Output
                              </button>
                              <button
                                type="button"
